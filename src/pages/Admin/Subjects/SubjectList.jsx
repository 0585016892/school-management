    ...
    },
    {
      ...
      render: (_, record) => (
        <Space onClick={(e) => e.stopPropagation()} size="small">
          {/* Phân công giảng dạy: ADMIN, PRINCIPAL, VICE_PRINCIPAL, DEPARTMENT_HEAD */}
          <CanRole
            allowRoles={[
              ROLES.ADMIN,
              ROLES.PRINCIPAL,
          ...
          {/* Chỉnh sửa môn học: ADMIN, PRINCIPAL, VICE_PRINCIPAL */}
          <CanRole
          ...
          {/* Xóa môn học: Chỉ ADMIN và PRINCIPAL */}
    ...
    <div style={styles.container}>
      ...
      <Card bordered={false} style={styles.tableCard}>
        ...
        >
          ...
          <Col>
            {/* Nút tạo môn học mới: Chỉ ADMIN và PRINCIPAL */}
            <CanRole allowRoles={[ROLES.ADMIN, ROLES.PRINCIPAL]}>
              <Button
                type="primary"
                icon={
