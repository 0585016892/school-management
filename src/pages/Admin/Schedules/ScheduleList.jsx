...
const ScheduleList = () => {
  const { hasRole } = useHasRole(); // Kiểm tra vai trò của người dùng hiện tại

  // Kiểm tra quyền chỉnh sửa/thao tác trên lịch học
  const canManageSchedule = hasRole(
    ROLES.ADMIN,
    ROLES.PRINCIPAL,
        ...
        {cellData.map((item) => (
          <div key={item.id} style={styles.cellBox}>
            ...
            >
              ...
              {/* Chỉ hiển thị nút Sửa/Xóa tiết học nếu người dùng có quyền quản lý lịch học */}
              <CanRole
                allowRoles={[
                  ROLES.ADMIN,
                  ROLES.PRINCIPAL,
  ...
  return (
    <div style={styles.container}>
      ...
      <Row justify="space-between" align="middle" style={{ marginBottom: 24 }}>
        ...
        <Col>
          {/* Nút Thêm Lịch Học Mới: Bọc CanRole chỉ dành cho BGH & Tổ trưởng */}
          <CanRole
            allowRoles={[
              ROLES.ADMIN,
              ROLES.PRINCIPAL,
