...
import { ROLES } from "../../../constants/roles"; // 🌟 Import enum ROLES
...
function Login() {
  ...
  const onFinishLogin = async (values) => {
    try {
      ...
      // 🌟 DANH SÁCH CÁC ROLE QUẢN LÝ / HỆ THỐNG SỬ DỤNG ADMIN LAYOUT
      const adminRoles = [
        ROLES.ADMIN,
        ROLES.PRINCIPAL,
      ...
      if (adminRoles.includes(role)) {
        // Điều hướng vào hệ thống Admin cho tất cả các role quản lý (bao gồm department_head)
        navigate("/admin");
        ...
        navigate("/admin/attendance"); // Phụ huynh chuyển hướng đến trang xem điểm danh/học phí
      } else {
        navigate("/admin");
      }
    } catch (err) {
