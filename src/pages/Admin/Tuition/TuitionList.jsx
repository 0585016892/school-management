...
const TuitionPage = () => {
  ...
  const mainColumns = [
    ...
    },
    {
      ...
      render: (_, record) => (
        <Space size="small">
          {/* Nút Thu tiền: ADMIN, PRINCIPAL, OFFICE_STAFF */}
          <CanRole
          ...
          {/* Nút Xóa: Chỉ ADMIN và PRINCIPAL */}
          <CanRole allowRoles={[ROLES.ADMIN, ROLES.PRINCIPAL]}>
            <Popconfirm
              ...
              <Card bordered={false} style={styles.tableCard}>
                ...
                >
                  ...
                  <Col xs={24} sm={8} md={10} style={{ textAlign: "right" }}>
                    {/* Nút Tạo thông báo học phí: ADMIN, PRINCIPAL, OFFICE_STAFF */}
                    <CanRole
                      allowRoles={[
                        ROLES.ADMIN,
                        ROLES.PRINCIPAL,
