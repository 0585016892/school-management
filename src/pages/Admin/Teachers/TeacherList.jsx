...
import CanRole from "../../../components/CanRole";
...
function TeacherList() {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (_, record) => (
        <Space size="middle">
          {/* Quyền xem hồ sơ: ADMIN, PRINCIPAL, VICE_PRINCIPAL */}
          <CanRole
          ...
          {/* Quyền chỉnh sửa: ADMIN, PRINCIPAL */}
  ...
  return (
    <div style={styles.container}>
      ...
      <Row justify="space-between" align="middle" style={{ marginBottom: 24 }}>
        ...
        <Col>
          {/* Nút thêm giáo viên mới: Chỉ ADMIN và PRINCIPAL có quyền */}
          <CanRole allowRoles={[ROLES.ADMIN, ROLES.PRINCIPAL]}>
            <Button
              type="primary"
              icon={
