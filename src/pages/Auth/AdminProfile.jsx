...
const AdminProfile = () => {
  ...
  const fetchProfileAndUsers = async () => {
    try {
      ...
      // Khớp chuẩn cấu trúc dữ liệu trả về từ Axios Interceptor hoặc bóc tách trực tiếp
  ...
  // 🌟 TÍNH NĂNG MỚI 1: Thay đổi vai trò trực tiếp (Promote/Demote Quyền hạn)
  const handleChangeRole = async (id, newRole) => {
    message.success("Chức năng này đang được phát triển");
  };

  // 🌟 TÍNH NĂNG MỚI 2: Xóa tài khoản vĩnh viễn khỏi Database
            ...
            <Card
              title={
                <Space size={8}>
                  ...
                  >
                    Bảng điều khiển tối cao (Hệ thống quản lý Users toàn trường)
                  </span>
                </Space>
              }
              bordered={false}
...
// HỆ THỐNG PHẲNG UI ĐỒNG BỘ DỰ ÁN QUẢN TRỊ
const styles = {
